...
import { getCart, updateCart } from '../../api/cart/index';
  ...
  const renderAddToCartButton = () => {
    ...
    if (isLoggedin) {
      ...
      return (productDetails && productDetails.addedToCart === 1) ? (
        ...
        <div className="product-details-action btn btn-primary text-decoration-none" 
        onClick={addToCart}>
        Add To Cart
        </div>
      )
            ...
            <div className="row">
              <div className="product-details-wrapper ">
                ...
                <div className="product-details-box ">
                  ...
                  <div className="product-price fw-bold"><i className="fa fa-inr" /> {productDetails.price}</div>
